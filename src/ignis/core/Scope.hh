...
// clang-format off
#define ON_SCOPE_EXIT    auto ANONYMOUS_VAR(SCOPE_EXIT)    = ignis::details::_ScopeGuardOnExit      {} + [&]()
#define ON_SCOPE_FAIL    auto ANONYMOUS_VAR(SCOPE_FAIL)    = ignis::details::_ScopeGuardOnFailure   {} + [&]()
#define ON_SCOPE_SUCCESS auto ANONYMOUS_VAR(SCOPE_SUCCESS) = ignis::details::_ScopeGuardOnSuccess   {} + [&]()
// clang-format on
